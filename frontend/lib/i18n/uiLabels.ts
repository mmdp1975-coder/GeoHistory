...
const en: UIDictionary = {
  ...
  "topbar.support.title": "Open feedback and customer care",
  "topbar.support.ariaLabel": "Open feedback and customer care",
  ...
  "timeline.sort.label": "Order",
  "timeline.sort.timeline": "Timeline",
  "timeline.sort.rating": "Top rated",
  "timeline.sort.favourites": "Favourites",
  "timeline.sort.published": "Newest",
  "timeline.sort.title.timeline": "Sort by timeline",
  "timeline.sort.title.rating": "Sort by rating",
  "timeline.sort.title.favourites": "Show favourites first",
  "timeline.sort.title.published": "Sort by publication date",
  "timeline.new_button": "New",
  "timeline.new_button_long": "Create journey",
  ...
  "support.hero.kicker": "Feedback & support",
  "support.hero.title": "Need assistance or want to share feedback?",
  "support.brand.title": "GeoHistory.io",
  "support.hero.intro":
    "This page is the contact point for feedback, support requests, and issue reports related to GeoHistory.",
  "support.hero.intro_secondary":
    "Contact us for technical issues, account questions, product suggestions, or general customer care requests.",
  "support.disclaimer":
  ...
  "support.direct.title": "Direct channel",
  "support.direct.copy":
    "Use this address for support requests, product feedback, and customer care.",
  "support.when.title": "When to contact us",
  "support.when.bug": "Technical bugs",
  "support.when.account": "Account issues",
  "support.when.suggestion": "Suggestions",
  "support.when.customer_care": "Customer care",
  "support.cta.email": "Send an email",
  "support.form.title": "Send structured feedback",
  "support.form.subtitle":
    "Choose the request type and provide the details we need to review it quickly.",
  "support.form.type.label": "Request type",
  "support.form.type.placeholder": "Select a type",
  "support.form.type.bug": "Bug",
  "support.form.type.support": "Support",
  "support.form.type.suggestion": "Suggestion",
  "support.form.type.content": "Content",
  "support.form.type.other": "Other",
  "support.form.area.label": "Area involved",
  "support.form.area.placeholder": "Select an area",
  "support.form.area.journey": "Journey",
  "support.form.area.timeline": "Timeline",
  "support.form.area.quiz": "Quiz",
  "support.form.area.account": "Account",
  "support.form.area.support": "Support",
  "support.form.area.other": "Other",
  "support.form.title.label": "Title",
  "support.form.title.placeholder": "A short summary",
  "support.form.message.label": "Message",
  "support.form.message.placeholder":
    "Describe the issue, your suggestion, or the help you need.",
  "support.form.reply.label": "I would like a reply",
  "support.form.email.label": "Contact email",
  "support.form.email.placeholder": "name@example.com",
  "support.form.submit": "Send feedback",
  "support.form.success": "Feedback sent successfully.",
  "support.form.error": "Unable to send feedback right now.",
  "support.form.validation.message": "Please enter a message.",
  "support.form.validation.email": "Please enter a valid email address.",
  ...
  "journey.description.title": "Description",
  "journey.description.none": "No description available.",
  "journey.description.show": "Show description",
  "journey.description.hide": "Hide description",
  "journey.quiz.open": "Open quiz",
  "journey.media.show": "Show media",
  "journey.media.hide": "Hide media",
  "journey.player.open": "Open player",
  "journey.player.close": "Close player",
  "journey.tab.description": "Description",
  ...
  "build.actions.new": "Manual",
  "build.actions.save": "Save",
  "build.actions.save.loading": "Saving...",
  "build.actions.import": "Upload",
  "build.actions.create_journey_group": "New Journey",
  "build.actions.approval": "Ask for approval",
  "build.actions.approval.loading": "Sending...",
  "build.actions.approve": "Approve",
  "build.actions.refuse": "Refuse",
  ...
  "build.sidebar.filter.pending": "Pending",
  "build.sidebar.status": "Status",
  "build.sidebar.status.all": "All",
  "build.sidebar.status.draft": "Draft",
  "build.sidebar.status.submitted": "Submitted",
  "build.sidebar.status.published": "Published",
  "build.sidebar.status.refused": "Refused",
  ...
  "build.translations.selected_label": "Active lang",
  ...
  "build.import.title": "Import journey from Excel",
  "build.import.description": "Upload an Excel file (.xlsx, .xls) with two sheets: Journey and Events. They should contain the base information to create the journey.",
  "build.import.select_label": "Choose Excel file",
  "build.import.selected": "Selected file",
  "build.import.template.button": "Download Excel template",
  "build.import.template.helper": "Template is empty with headers only. Lat/Lon must be text with dot decimal (e.g. 41.893). Era accepts AD or BC; years are numeric.",
  "build.import.requirement.journey": "Sheet Journey: base journey info (title, slug, language, visibility).",
  "build.import.requirement.events": "Sheet Events: base event info (dates, places, relations).",
  "build.import.error.missing_file": "Select an Excel file to continue.",
  "build.import.error.invalid_type": "Only Excel files (.xlsx, .xls) are allowed.",
  "build.import.error.missing_sheets": "The workbook must include sheets named Journey and Events.",
  "build.import.error.generic": "Unable to read the Excel file. Check the structure and try again.",
  "build.import.preview.title": "Workbook preview",
  "build.import.preview.journey_rows": "Journey rows",
  "build.import.preview.event_rows": "Event rows",
  "build.import.button.submit": "Load file",
  "build.import.button.apply": "Apply to form",
  "build.import.applied": "Workbook data loaded into the form. Review and then save.",
...
const it: UIDictionary = {
  ...
  "topbar.support": "Supporto",
  "topbar.support.title": "Apri la pagina feedback e customer care",
  "topbar.support.ariaLabel": "Apri la pagina feedback e customer care",
  "topbar.logout": "Esci",
  ...
  "timeline.sort.label": "Ordina",
  "timeline.sort.timeline": "Timeline",
  "timeline.sort.rating": "Piu votati",
  "timeline.sort.favourites": "Preferiti",
  "timeline.sort.published": "Nuovi",
  "timeline.sort.title.timeline": "Ordina per timeline",
  "timeline.sort.title.rating": "Ordina per valutazione",
  "timeline.sort.title.favourites": "Mostra prima i preferiti",
  "timeline.sort.title.published": "Ordina per data di pubblicazione",
  "timeline.new_button": "New",
  "timeline.new_button_long": "Crea journey",
  ...
  "support.hero.kicker": "Feedback e supporto",
  "support.hero.title": "Hai un suggerimento o ti serve assistenza?",
  "support.brand.title": "GeoHistory.io",
  "support.hero.intro":
    "Questa pagina è il punto di contatto per feedback, richieste di supporto e segnalazioni relative a GeoHistory.",
  "support.hero.intro_secondary":
    "Scrivici per problemi tecnici, dubbi sull'account, suggerimenti di miglioramento o richieste di assistenza generale.",
  "support.disclaimer":
  ...
  "support.direct.title": "Canale diretto",
  "support.direct.copy":
    "Usa questo indirizzo per richieste di assistenza, feedback prodotto e customer care.",
  "support.when.title": "Quando contattarci",
  "support.when.bug": "Bug tecnici",
  "support.when.account": "Problemi account",
  "support.when.suggestion": "Suggerimenti",
  "support.when.customer_care": "Assistenza utenti",
  "support.cta.email": "Invia una email",
  "support.form.title": "Invia un feedback strutturato",
  "support.form.subtitle":
    "Scegli il tipo di richiesta e aggiungi i dettagli utili per farti aiutare più velocemente.",
  "support.form.type.label": "Tipo di richiesta",
  "support.form.type.placeholder": "Seleziona un tipo",
  "support.form.type.bug": "Bug",
  "support.form.type.support": "Supporto",
  "support.form.type.suggestion": "Suggerimento",
  "support.form.type.content": "Contenuto",
  "support.form.type.other": "Altro",
  "support.form.area.label": "Area interessata",
  "support.form.area.placeholder": "Seleziona un'area",
  "support.form.area.journey": "Journey",
  "support.form.area.timeline": "Timeline",
  "support.form.area.quiz": "Quiz",
  "support.form.area.account": "Account",
  "support.form.area.support": "Supporto",
  "support.form.area.other": "Altro",
  "support.form.title.label": "Titolo",
  "support.form.title.placeholder": "Un breve riepilogo",
  "support.form.message.label": "Messaggio",
  "support.form.message.placeholder":
    "Descrivi il problema, il suggerimento o il tipo di aiuto che ti serve.",
  "support.form.reply.label": "Desidero una risposta",
  "support.form.email.label": "Email di contatto",
  "support.form.email.placeholder": "nome@example.com",
  "support.form.submit": "Invia feedback",
  "support.form.success": "Feedback inviato correttamente.",
  "support.form.error": "Impossibile inviare il feedback in questo momento.",
  "support.form.validation.message": "Inserisci un messaggio.",
  "support.form.validation.email": "Inserisci un'email valida.",
  ...
  "journey.description.title": "Descrizione",
  "journey.description.none": "Nessuna descrizione disponibile.",
  "journey.description.show": "Mostra descrizione",
  "journey.description.hide": "Nascondi descrizione",
  "journey.quiz.open": "Apri il quiz",
  "journey.media.show": "Mostra media",
  "journey.media.hide": "Nascondi media",
  "journey.player.open": "Apri player",
  "journey.player.close": "Chiudi player",
  "journey.tab.description": "Descrizione",
  "journey.tab.wiki": "Wiki",
  ...
  "build.actions.import": "Upload",
  "build.actions.create_journey_group": "Crea Journey",
  "build.actions.approval": "Richiedi approvazione",
  "build.actions.approval.loading": "Invio...",
  "build.actions.approve": "Approva",
  "build.actions.refuse": "Rifiuta",
  ...
  "build.sidebar.filter.pending": "Da approvare",
  "build.sidebar.status": "Stato",
  "build.sidebar.status.all": "Tutti",
  "build.sidebar.status.draft": "Bozza",
  "build.sidebar.status.submitted": "Inviato",
  "build.sidebar.status.published": "Pubblicato",
  "build.sidebar.status.refused": "Rifiutato",
  ...
  "build.translations.selected_label": "Lingua attiva",
  ...
  "build.import.title": "Importa journey da Excel",
  "build.import.description": "Carica un file Excel (.xlsx, .xls) con due fogli: Journey ed Events. Devono contenere le informazioni base per creare il journey.",
  "build.import.select_label": "Scegli il file Excel",
  "build.import.selected": "File selezionato",
  "build.import.template.button": "Scarica template Excel",
  "build.import.template.helper": "Template vuoto con sole intestazioni. Lat/Lon in testo con '.' come decimale (es. 41.893). Era accetta AD o BC; gli anni sono numerici.",
  "build.import.requirement.journey": "Foglio Journey: informazioni base del viaggio (titolo, slug, lingua, visibilità).",
  "build.import.requirement.events": "Foglio Events: informazioni base degli eventi (date, luoghi, relazioni).",
  "build.import.error.missing_file": "Seleziona prima un file Excel.",
  "build.import.error.invalid_type": "Sono ammessi solo file Excel (.xlsx, .xls).",
  "build.import.error.missing_sheets": "Il file deve contenere i fogli Journey ed Events.",
  "build.import.error.generic": "Impossibile leggere il file Excel. Controlla la struttura e riprova.",
  "build.import.preview.title": "Anteprima workbook",
  "build.import.preview.journey_rows": "Righe Journey",
  "build.import.preview.event_rows": "Righe Events",
  "build.import.button.submit": "Carica file",
  "build.import.button.apply": "Applica al form",
  "build.import.applied": "Dati del file caricati nel form. Controlla e poi salva.",
