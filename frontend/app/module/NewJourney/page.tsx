          ...
          {rows.map((j) => {
            ...
            return (
              <li
                ...
                data-slug={j.journey_slug}
              >
                {/* 🔗 L'intera card è cliccabile, come in /module/rating */}
                <Link
                  href={`/module/group_event?gid=${encodeURIComponent(j.journey_id)}`}
                  prefetch={false}
                  className="block"
                >
                  {/* HEADER: immagine + cuore */}
                  ...
                  {/* BODY: titolo/data/stella come rating */}
                  <div className="p-4">
                    <div
                      className="
                        mb-1 grid gap-x-2
                    ...
                    >
                      ...
                      {/* Data: col 2, row 1 — una riga fissa */}
                      {published && (
                        <span
                          className="
                            col-[2] row-[1]
                    ...
                    <div className="mt-3 flex items-center justify-between gap-2 text-xs text-neutral-600">
                      ...
                      {/* Etichetta "Open" puramente visiva (la card è già un Link) */}
